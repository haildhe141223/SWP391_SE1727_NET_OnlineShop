...
namespace SWP391.OnlineShop.Portal.Controllers
{
	...
	public class ProfileController : BaseController
	{
		...
		public async Task<IActionResult> RequestToBecomeMarketer(ProfileViewModels request)
		{
			...
			var name = request.RequestViewModel.RequestMarketingViewModel.Name.Trim();
			...
			var samplePostLink = request.RequestViewModel.RequestMarketingViewModel.SamplePostLink.Trim();
